...
class AdminGenreController extends AbstractController
{
    ...
    {
        return $this->render('admin/genre/index.html.twig', ['genres' => $genreRepository->findAll()]);
    }
    ...
    public function edit(Request $request, Genre $genre): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin.genre.index', ['id' => $genre->getId()]);
        }
    ...
    /**
     * @Route("/{id}/delete", name="admin.genre.delete")
     */
